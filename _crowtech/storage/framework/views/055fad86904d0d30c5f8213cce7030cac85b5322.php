<div class="modal-header">
    <h5 class="modal-title" id="modelHeading"><?php echo e(ucfirst($platform)); ?> <?php echo app('translator')->get('restapi::app.devices'); ?></h5>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'sendPushNotification','class' => 'ajax-form']); ?>
                            ...
                            <div class="form-group m-b-10">
                                <div class="form-group my-3">
                                    <label class="f-14 text-dark-grey mb-12 w-100"
                                           for="usr"><?php echo app('translator')->get('restapi::app.selectDevice'); ?></label>
                                    <div class="d-flex">
...
<?php $component = App\View\Components\Forms\Radio::resolve(['fieldId' => 'status_review'.$device->device_id,'fieldLabel' => $device->device_id,'fieldName' => 'device_id','fieldValue' => $device->registration_id] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                        ...
                        <?php else: ?>
                            <?php echo app('translator')->get('restapi::app.noRegisterDeviceFound'); ?>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
...
<?php $component = App\View\Components\Forms\ButtonPrimary::resolve(['disabled' => !$devices->count(),'icon' => 'check'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'send-push-notification']); ?><?php echo app('translator')->get('app.send'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    ...
    $('#send-push-notification').click(function () {
        $.easyAjax({
            url: "<?php echo e(route('rest-api.send_push')); ?>",
...
<?php /**PATH /home/u793119200/domains/cakekrate.com/public_html/crowtech/Modules/RestAPI/Providers/../Resources/views/setting/test-push.blade.php ENDPATH**/ ?>