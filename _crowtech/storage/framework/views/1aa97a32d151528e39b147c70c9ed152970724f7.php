...
<?php endif; ?>
                            ...
                            <td class="text-darkest-grey"><?php echo e($item->leave_date->translatedFormat(company()->date_format)); ?></td>
                            <td class="f-14">
...
<?php $component->withAttributes([]); ?>
                    <?php $__empty_1 = true; $__currentLoopData = $newTickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td class="text-darkest-grey" width="15%"><?php echo e($item->updated_at->translatedFormat(company()->date_format)); ?></td>
...
<?php $component->withAttributes([]); ?>
                    <?php $__empty_1 = true; $__currentLoopData = $pendingTasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td width="15%"><?php if(!is_null($task->due_date)): ?> <?php echo e($task->due_date->translatedFormat(company()->date_format)); ?> <?php else: ?> -- <?php endif; ?></td>
                            <td class="f-14 pr-20 text-right" width="20%">
                                <?php if (isset($component)) { $__componentOriginal2db42a9094af8c45b35737ea3527d3c0817d84c4 = $component; } ?>
...
<?php /**PATH /home/u793119200/domains/cakekrate.com/public_html/crowtech/resources/views/dashboard/ajax/overview.blade.php ENDPATH**/ ?>