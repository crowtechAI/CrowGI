...
<aside class="<?php echo e(!user()->dark_theme ? 'sidebar-' . $appTheme->sidebar_theme : ''); ?>">
    ...
    <div
        ...
        <div class="d-flex align-items-center">
            <p class="mb-0 text-dark-grey bg-secondary text-light px-1 py-0 rounded f-10 border-dark">v<?php echo e(File::get('version.txt')); ?></p>
            <?php if(in_array('admin', user_roles()) && isWorksuiteSaas()): ?>
                <p class="mb-0"><a href="<?php echo e(route('superadmin.faqs.index')); ?>" class="text-secondary ml-2 f-15"><i class="fa fa-question-circle"></i></a></p>
            <?php endif; ?>
        </div>
    </div>
    <!-- Sidebar Toggler -->
...
<?php /**PATH /home/u793119200/domains/cakekrate.com/public_html/crowtech/resources/views/sections/sidebar.blade.php ENDPATH**/ ?>