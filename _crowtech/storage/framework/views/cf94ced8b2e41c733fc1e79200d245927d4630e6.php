...
<?php $component->withAttributes(['type' => 'success','icon' => 'info-circle']); ?>
                        <?php echo e(__('superadmin.impersonate')); ?> <b><?php echo e(company()->company_name); ?></b>
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
                                                    ...
                                                    <td>
                                                        <?php if(isset($weekShifts[$key]->shift)): ?>
                                                            <?php if($weekShifts[$key]->shift->shift_name == 'Day Off'): ?>
                                                                <span class="badge badge-secondary"><?php echo e($weekShifts[$key]->shift->shift_name); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="pr-20" align="right">
                                                ...
                                                <?php elseif($task->due_date->endOfDay()->isPast()): ?>
                                                    <span
                                                        class="text-danger"><?php echo e($task->due_date->translatedFormat(company()->date_format)); ?></span>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u793119200/domains/cakekrate.com/public_html/crowtech/resources/views/dashboard/employee/index.blade.php ENDPATH**/ ?>